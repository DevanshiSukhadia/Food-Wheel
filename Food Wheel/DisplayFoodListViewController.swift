...
//  yelpapi
//
//  Created by Ayesha Khan on 11/26/18.
//  Copyright © 2018 Ayesha Khan. All rights reserved.
//

import UIKit

class DisplayFoodListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        execute(apiurl: "https://api.yelp.com/v3/businesses/search?term=food&location=san+jose&category=greek")
        print(self.stores)
        //        textView.insertText()
    }
